...
#mxnet
#python ../../tools/launch.py -n 1 -s 1 --launcher ssh -H hosts --sync-dst-dir /home/xugb/image-classification_test/  python train_mnist.py --network lenet --kv-store dist_sync
echo "hello world"
